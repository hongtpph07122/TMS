...
public class GetUnreachable {
    ...
    private String fromNextCallTime;
    private String toNextCallTime;
    ...
    public String getFromNextCallTime() {
        return fromNextCallTime;
    }

    public void setFromNextCallTime(String fromNextCallTime) {
        this.fromNextCallTime = fromNextCallTime;
    }

    public String getToNextCallTime() {
        return toNextCallTime;
    }

    public void setToNextCallTime(String toNextCallTime) {
        this.toNextCallTime = toNextCallTime;
    }
