...
public class UpdDoNewV4 {
    ...
    private Integer conditionDoId;
    private Integer conditionSoId;
    private String conditionTrackingCode;
    ...
    public Integer getConditionDoId() {
        return conditionDoId;
    }

    public void setConditionDoId(Integer conditionDoId) {
        this.conditionDoId = conditionDoId;
    }

    public Integer getConditionSoId() {
        return conditionSoId;
    }

    public void setConditionSoId(Integer conditionSoId) {
        this.conditionSoId = conditionSoId;
    }

    public String getConditionTrackingCode() {
        return conditionTrackingCode;
    }

    public void setConditionTrackingCode(String conditionTrackingCode) {
        this.conditionTrackingCode = conditionTrackingCode;
    }
