...
public class SaleOrder implements Comparable<SaleOrder> {
    ...
    @Override
    public int compareTo(SaleOrder otherSaleOrder) {
        return this.getCreatedate().compareTo(otherSaleOrder.getCreatedate());
    }
