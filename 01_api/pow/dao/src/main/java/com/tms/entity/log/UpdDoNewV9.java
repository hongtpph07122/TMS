...
public class UpdDoNewV9 {
    ...
    public String getFirstdelivertime() {
        return firstdelivertime;
    }

    public void setFirstdelivertime(String firstdelivertime) {
    ...
    public String getHandoveredTime() {
        return handoveredTime;
    }

    public void setHandoveredTime(String handoveredTime) {
