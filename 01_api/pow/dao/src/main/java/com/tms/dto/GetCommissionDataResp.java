...
public class GetCommissionDataResp {
    ...
    public void setDoStatusid(String doStatusid) {
    ...
    public void setDoCreatedate(String doCreatedate) {
        this.doCreatedate = doCreatedate;
    }
