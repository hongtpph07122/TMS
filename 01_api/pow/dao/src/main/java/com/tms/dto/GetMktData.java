...
public class GetMktData {
    ...
    public List<Integer> getLeadId() {
        return leadId;
    }

    public void setLeadId(List<Integer> leadId) {
        this.leadId = leadId;
    }
    ...
    public Integer getCustDob() {
        return custDob;
    }

    public void setCustDob(Integer custDob) {
