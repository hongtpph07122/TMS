...
public class UpdateCLCallbackByAssigned {
    ...
    private Integer conditionAssigned;
    ...
    public Integer getConditionAssigned() {
        return conditionAssigned;
    }

    public void setConditionAssigned(Integer conditionAssigned) {
        this.conditionAssigned = conditionAssigned;
    }
