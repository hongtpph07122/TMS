...
public class InsCLFreshV11 {
    ...
    public Integer getCrmActionType() {return crmActionType;}

    public void setCrmActionType(Integer crmActionType) {this.crmActionType = crmActionType;}
    ...
    public String getFcrTime() {
        return fcrTime;
    }

    public void setFcrTime(String fcrTime) {
