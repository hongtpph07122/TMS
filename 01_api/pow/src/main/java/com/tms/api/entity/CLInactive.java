...
@Entity
@Table(name = "cl_inactive")
public class CLInactive implements Serializable {
	@Id
	@SequenceGenerator(name = "clinactive_generator", sequenceName = "seq_lead_id", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "clinactive_generator")
	@Column(name = "lead_id")
