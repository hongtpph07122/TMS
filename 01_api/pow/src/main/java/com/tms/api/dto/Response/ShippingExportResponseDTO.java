...
public class ShippingExportResponseDTO {
	...
	public static List<ShippingExportResponseDTO> buildMappedToDTO(
			List<GetShippingExportResp> getShippingExportRespList,
			OrderManagementRequestDTO orderManagementRequestDTO) {
		List<ShippingExportResponseDTO> shippingExportResponseDTOS = new ArrayList<>();
		for(GetShippingExportResp exportResp: getShippingExportRespList){
			ShippingExportResponseDTO shippingExportResponseDTO = new ShippingExportResponseDTO();
