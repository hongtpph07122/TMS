            ...
            <div class="col-sm-12 col-xs-12 module-action-bar clearfix " style="padding-left: 0px;">
                <div class="module-action-content clearfix BhsCallStrategy-module-action-content">
                    <div class="col-lg-8 col-md-8 module-breadcrumb module-breadcrumb-List transitionsAllHalfSecond">
                        <h4 class="module-title pull-left"> {vtranslate('LBL_CREATELEAD', $MODULE)}</h4>
                    </div>
...
{*                    <li class="breadcrumb-item"><a href="{$HOME_MODULE_MODEL->getDefaultUrl()}">{vtranslate('LBL_HOME', $MODULE)}</a></li>*}
{*                    <li class="breadcrumb-item"><a href="index.php?module=BhsOrders&view=List&app=BHS_ORDERS">{vtranslate('LBL_ORDERS', $MODULE)}</a></li>*}
{*                    <li class="breadcrumb-item active" aria-current="page">{vtranslate('LBL_CREATELEAD', $MODULE)}</li>*}
{*                </ol>*}
{*            </nav>*}
