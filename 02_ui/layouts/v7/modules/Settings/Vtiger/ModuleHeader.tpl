...
{strip}
	<div class="module-action-bar clearfix coloredBorderTop" style="padding-left:0px; margin-bottom: 10px;">
...
{*						</span>*}
		...
		{*							</span>*}
			...
			<div class="col-lg-5 col-md-5 pull-right">
				<div id="appnav" class="navbar-right navbar-right-setting">
