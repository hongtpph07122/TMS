...
{strip}
	...
	<style>
		body {
			background:  url(layouts/v7/resources/Images/background-emloyee.png);
			...
			<div id="forgotPasswordDiv" class="hide">
				<form class="form-horizontal" action="forgotPassword.php" method="POST">
					...
					<div class="group">
						...
						<span><a class="forgotPasswordLink"><i class="fa fa-long-arrow-left" aria-hidden="true"></i> Back to Sign In</a></a></span>
					</div>
				</form>
			</div>
		</div>
