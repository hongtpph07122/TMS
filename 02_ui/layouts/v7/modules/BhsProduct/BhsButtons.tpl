{strip}
    {if $smarty.request.view eq 'List'}
       <div class="mx-auto" style="display:flex">
           <button id="btnAddCustomer" type="button" class="btn module-buttons btn-bhs btnCreateProduct"><i class="material-icons">add</i><span class="hidden-sm hidden-xs">{vtranslate('Add Product', $MODULE)}</span></button>
