...
{strip}
    ...
    <script type="text/javascript" src="{vresource_url('layouts/v7/lib/perfect-scrollbar.min.js')}"></script>
    <script type="text/javascript" src="{vresource_url('layouts/v7/lib/bhs_script.js')}"></script>
    <script type="text/javascript" src="{vresource_url('layouts/v7/resources/socket.js')}"></script>
    <script type="text/javascript" src="layouts/v7/lib/jquery/daterangepicker/jquery.daterangepicker.js"></script>
