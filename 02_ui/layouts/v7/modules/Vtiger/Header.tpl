...
<html>
	<head>
		...
		<link type='text/css' rel='stylesheet' href="https://fonts.googleapis.com/css?family=Roboto:400,400i,500,500i,700,700i&display=swap">
		<link type='text/css' rel='stylesheet' href='https://fonts.googleapis.com/icon?family=Material+Icons'>
		<link type='text/css' rel='stylesheet' href='https://fonts.googleapis.com/css?family=Work+Sans:400,500,600,700produ'>
		<link type='text/css' rel='stylesheet' href='layouts/v7/lib/themify-icons/themify-icons.css'>
		...
		<link type='text/css' rel='stylesheet' href='layouts/v7/lib/sidebar.css'>
        <link type='text/css' rel='stylesheet' href='layouts/v7/lib/bhs_style.css'>
        <link type='text/css' rel='stylesheet' href='libraries/jquery/datetimepicker/bootstrap-datetimepicker.min.css'>
        <link type="text/css" rel="stylesheet" href="layouts/v7/lib/bootstrap-daterangepicker/daterangepicker.css?v=7.1.0" media="screen">
		...
		{/foreach}
		<link type='text/css' rel='stylesheet' href='layouts/v7/lib/common.css'>
	...
	<body data-skinpath="{Vtiger_Theme::getBaseThemePath()}" data-language="{$LANGUAGE}" data-user-decimalseparator="{$CURRENT_USER_MODEL->get('currency_decimal_separator')}" data-user-dateformat="{$CURRENT_USER_MODEL->get('date_format')}"
          ...
          data-user-calendar-reminder-interval="{$CURRENT_USER_MODEL->getCurrentUserActivityReminderInSeconds()}">
            ...
            <script async src="https://www.googletagmanager.com/gtag/js?id=UA-171486211-1"></script>
            {literal}<script>
              window.dataLayer = window.dataLayer || [];
              function gtag(){dataLayer.push(arguments);}
              gtag('js', new Date());
            
              gtag('config', 'UA-171486211-1');
            </script>
            {/literal}
