...
class BhsSap_ExportToExcel_Action extends Vtiger_BhsExport_Action {
    ...
    function exportData(Vtiger_Request $request) {
        ...
        if (!empty($params['doIds'])){
            $params = $params['doIds'];
            $url = 'DO/sap/ids/csv?doIds='.implode('&doIds=',$params);
        ...
        header('Content-Disposition: attachment; filename=Sap.csv');
