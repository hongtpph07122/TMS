...
class BhsShippingPending_ExportToExcel_Action extends Vtiger_BhsExport_Action {
    ...
    function exportData(Vtiger_Request $request) {
        ...
        $result = $moduleModel->makeApiCall('GET', 'DO/pending/csv', $request2);
        $decoded =$result["body"];
        $fileName = 'ShippingPending.csv';
