...
class Vtiger_MenuStructure_Model extends Vtiger_Base_Model {
	...
	public static function getAppMenuList(){
		return array(
            ...
            'BHS_MONITOR', 'BHS_CUSTOMER', 'BHS_CAMPAIGN', 'BHS_ORDERS', 'BHS_CALLBACK', 'BHS_PRODUCT', 'BHS_REPORTS', 'BHS_SYSTEM'
        );
	}

	public static function getAppIcons() {
		$appImageIcons = array(	'MARKETING' => 'fa fa-users',
								'SALES'		=> 'fa fa-dot-circle-o',
								'SUPPORT'	=> 'fa fa-life-ring',
								'INVENTORY'	=> 'fa vicon-inventory',
								'PROJECT'	=> 'fa fa-briefcase',
								'TOOLS'		=> 'fa fa-wrench',
								'MONITOR'	=> 'fa fa-users',
								'BHS_MONITOR' => 'fa fa-video-camera',
								'BHS_CUSTOMER' => 'fa fa-user',
								'BHS_CAMPAIGN' => 'fa fa-bullhorn',
								'BHS_ORDERS' => 'assignment',
								'BHS_CALLBACK' => 'fa fa-phone',
								'BHS_PRODUCT' => 'fa fa-cube',
								'BHS_REPORTS' => 'fa fa-bar-chart',
								'BHS_SYSTEM' => 'fa fa-cogs',
//								submenu
								'BhsCampaign' => 'notifications',
								'BhsAgentMonitoring' => 'business',
								'BhsCustomer' => 'perm_identity',
								'BhsCdrs' => 'list_alt',
								'BhsMissedCalls' => 'phone_missed',
								'BhsCampaignManagement' => 'location_city',
								'BhsCallStrategy' => 'phone_in_talk',
								'BhsSearchOrders' => 'dialer_sip',
								'BhsOrderProcessing' => 'equalizer',
								'BhsOrders' => 'fiber_new',
								'BhsValidation' => 'check_circle_outline',
								'BhsShipping' => 'directions_bike',
								'BhsSap' => 'directions_bike',
                                'BhsKerry' => 'directions_bike',
								'BhsShippingPending' => 'directions_run',
								'BhsCallbackManagement' => 'phonelink_setup',
								'BhsCallbackList' => 'list_alt',
								'BhsProduct' => 'chrome_reader_mode',
                                'BhsCombo' => 'scatter_plot',
								'BhsStock' => 'business_center',
                                'BhsAgentReport' => 'receipt',
                                'BhsCallcenterReport' => 'loyalty',
                                'BhsCampaignReport' => 'timeline',
                                'BhsAgentGroup' => 'group_work',
                                'BhsBlacklist' => 'recent_actors',
							);
