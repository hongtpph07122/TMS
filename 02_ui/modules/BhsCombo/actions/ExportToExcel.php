...
class BhsCombo_ExportToExcel_Action extends Vtiger_BhsExport_Action {
    ...
    function exportData(Vtiger_Request $request) {
        ...
        if (!empty($params['doIds'])){
            $params = $params['doIds'];
            $url = 'DO/dhl/ids/csv?doIds='.implode('&doIds=',$params);
        ...
        header('Content-Disposition: attachment; filename=DHL.csv');
