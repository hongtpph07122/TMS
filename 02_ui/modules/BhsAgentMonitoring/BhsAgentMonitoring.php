<?php
class BhsAgentMonitoring extends CRMEntity {
	var $db, $log; // Used in class functions of CRMEntity

	var $table_name = 'vtiger_bhsagentmonitoring';
	var $table_index= 'bhsagentmonitoringid';
	 ...
	 */
	var $customFieldTable = Array('vtiger_bhsagentmonitoringcf', 'bhsagentmonitoringid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_bhsagentmonitoring', 'vtiger_bhsagentmonitoringcf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_bhsagentmonitoring' => 'bhsagentmonitoringid',
		'vtiger_bhsagentmonitoringcf'=>'bhsagentmonitoringid');
	...
	var $list_fields = Array (
        ...
        'Name' => Array('bhsagentmonitoring', 'bhsagentmonitoring_name'),
		'CreatedTime' => Array('crmentity', 'createdtime'),
	);
	var $list_fields_name = Array (
		/* Format: Field Label => fieldname */
		'Name' => 'bhsagentmonitoring_name',
	...
	var $def_basicsearch_col = 'bhsagentmonitoring_name';
	...
	var $mandatory_fields = Array('bhsagentmonitoring_name');

	var $default_order_by = 'bhsagentmonitoring_name';
	...
	function vtlib_handler($moduleName, $eventType) {
		...
		if($eventType == 'module.postinstall') {
			...
			vtws_deleteWebserviceEntity('BhsAgentMonitoring');
    ...
    public function addModuleIcon(){
        ...
        $source1 = $root_directory . '/modules/BhsAgentMonitoring/resources/BhsAgentMonitoring.png';
        $source2 = $root_directory . '/modules/BhsAgentMonitoring/resources/moduleImages/BhsAgentMonitoring.png';
        $dest1 = $root_directory . '/layouts/v7/skins/images/BhsAgentMonitoring.png';
        copy($source1, $dest1);
        $dest2 = $root_directory . '/layouts/v7/skins/images/moduleImages/BhsAgentMonitoring.png';
        copy($source2, $dest2);
    }
    ...
    public function addDefaultModuleTypeEntity(){
		global $adb;
        // Check entity module
        $rs=$adb->query("SELECT * FROM `vtiger_ws_entity` WHERE `name`='BhsAgentMonitoring'");
        if($adb->num_rows($rs) == 0) {
            ...
            $adb->pquery("INSERT INTO `vtiger_ws_entity` (`id`, `name`, `handler_path`, `handler_class`, `ismodule`) VALUES (?, ?, ?, ?, ?);",
                array($entityId, 'BhsAgentMonitoring', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', '1'));
        }
    }

    public function addEntityIdentifier(){
        global $adb;
        $moduleName = 'BhsAgentMonitoring';
        ...
        if($adb->num_rows($result) > 0){
            ...
            if($adb->num_rows($result2)==0){
                $adb->pquery("INSERT INTO vtiger_entityname(tabid, modulename, tablename, fieldname, entityidfield, entityidcolumn) VALUES(?,?,?,?,?,?)",
                    Array($tabid, $moduleName, $this->table_name, 'bhsagentmonitoring_name', $this->table_index, $this->table_index));
            }else{
